...
class GroupsPage(ttk.Frame):
    ...
    def setup_folder_manager_frame(self):
        ...
        CTkLabel(self.folder_frame, text=self.group_name, font=('Arial Bold', 20)).pack(side='left', anchor='w', padx=5, pady=3)

        CTkButton(self.folder_frame, text="folder1", fg_color='transparent').pack(side='left', anchor='w', padx=5, pady=3)
